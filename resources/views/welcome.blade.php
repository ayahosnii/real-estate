...
<div class="properties section">
    <div class="container">
        ...
        <div class="row">
            @foreach($modernHouses as $modernHouse)
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="property-details.html"><img src="assets/images/{{ $modernHouse->getHouseInformation()->getImage()}}" alt=""></a>
                        <span class="category">{{ $modernHouse->getHouseInformation()->getType()}}</span>
                        <h6>$584.500</h6>
                        <h4><a href="property-details.html">{{$modernHouse->getHouseInformation()->getAddress()}}</a></h4>
                        <ul>
                            <li>Bedrooms: <span>{{ $modernHouse->getRooms()->getbedRoom()->getNumber()}}</span></li>
                            <li>Bathrooms: <span>{{ $modernHouse->getRooms()->getBathRoom()->getNumber()}}</span></li>
                            <li>Area: <span>{{$modernHouse->getHouseInformation()->getTotalArea()}}m2</span></li>
                            <li>Floor: <span>25th</span></li>
                            <li>Parking: <span>{{ $modernHouse->getFeatures()->hasParking() ? 'Yes': 'No'}}</span></li>
                        </ul>
